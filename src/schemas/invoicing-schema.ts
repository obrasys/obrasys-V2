...
export const invoiceSchema = z.object({
  ...
  invoice_number: z
    .string()
    .min(1, "O número da fatura é obrigatório."),
  ...
  total_amount: z
    .coerce
    .number()
    .min(0, "O valor total deve ser positivo.")
    .default(0),
  ...
  /* ==================================================
     RETENÇÃO NA FONTE
     (calculada SOBRE O SUBTOTAL, SEM IVA)
  ================================================== */
  withholding_rate: z
    .coerce
    .number()
...
export const invoiceItemSchema = z.object({
  ...
  unit_price: z
    .coerce
    .number()
    .min(0.01, "O preço unitário deve ser positivo."),
...
export const paymentSchema = z.object({
  ...
  invoice_id: z
    .string()
    .uuid()
    .min(1, "O ID da fatura é obrigatório."),
...
export const expenseSchema = z.object({
  ...
  description: z
    .string()
    .min(1, "A descrição da despesa é obrigatória."),
